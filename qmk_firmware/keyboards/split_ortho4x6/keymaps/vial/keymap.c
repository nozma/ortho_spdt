...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
         ...
         LT(5,KC_ENTER),         QK_BOOT,            KC_Y,            KC_U,
                   KC_I,            KC_O,            KC_P,  KC_TRANSPARENT,
                   KC_H,            KC_J,            KC_K,      LT(4,KC_L),
           KC_SEMICOLON,            KC_N,            KC_M,        KC_COMMA,
                 KC_DOT,  RSFT_T(KC_SLASH),  LT(6,KC_SPACE), LT(2,KC_LANGUAGE_1),
              KC_ESCAPE
    ),
    [1] = LAYOUT(
    ...
    [2] = LAYOUT(
                ...
                KC_KP_5,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,
         KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,
          KC_LEFT_SHIFT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,
         KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,
         KC_TRANSPARENT,  KC_TRANSPARENT,         KC_KP_6,         KC_KP_7,
                KC_KP_8,         KC_KP_9,         KC_KP_0,  KC_TRANSPARENT,
                KC_LEFT,         KC_DOWN,           KC_UP,        KC_RIGHT,
         KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,
         KC_TRANSPARENT,  KC_RIGHT_SHIFT,  KC_TRANSPARENT,  KC_TRANSPARENT,
         KC_TRANSPARENT
    ),
    [3] = LAYOUT(
                   KC_Q,  (QK_LCTL|KC_W),  (QK_LCTL|KC_E),  (QK_LCTL|KC_R),
         (QK_LCTL|KC_T),  KC_TRANSPARENT,  KC_TRANSPARENT, (QK_LGUI|KC_LEFT),
         (QK_LCTL|KC_D),        KC_RIGHT,  (QK_LCTL|KC_G),  KC_TRANSPARENT,
         (QK_LCTL|KC_Z),  (QK_LCTL|KC_X),  (QK_LCTL|KC_C),  (QK_LCTL|KC_V),
                KC_LEFT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,
        (QK_LCTL|KC_ENTER),  KC_TRANSPARENT,  (QK_LCTL|KC_Y),  (QK_LCTL|KC_U),
         (QK_LCTL|KC_I),  (QK_LCTL|KC_O),           KC_UP,  KC_TRANSPARENT,
           KC_BACKSPACE,  (QK_LCTL|KC_J),  (QK_LCTL|KC_K),  (QK_LCTL|KC_L),
        (QK_LCTL|KC_SEMICOLON),         KC_DOWN,  (QK_LCTL|KC_M), (QK_LCTL|KC_COMMA),
        (QK_LCTL|KC_DOT), (QK_LCTL|KC_SLASH), (QK_LCTL|KC_SPACE),  KC_TRANSPARENT,
         KC_TRANSPARENT
    ),
    [4] = LAYOUT(
         KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,
         KC_TRANSPARENT,  KC_TRANSPARENT,    KC_LEFT_CTRL,  KC_TRANSPARENT,
         KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,
          KC_LEFT_SHIFT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,
         KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,
         KC_TRANSPARENT,  KC_TRANSPARENT, (QK_LCTL|KC_BACKSLASH), (QK_LCTL|QK_LGUI|KC_I),
        KC_MISSION_CONTROL,  (QK_LSFT|KC_L),  KC_TRANSPARENT,  KC_TRANSPARENT,
         (QK_LSFT|KC_H),      KC_MS_BTN1,      KC_MS_BTN2,  KC_TRANSPARENT,
         KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,
         KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,
         KC_TRANSPARENT
    ),
    [5] = LAYOUT(
         ...
         KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,
         KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,
         KC_TRANSPARENT, (QK_LSFT|KC_RIGHT_BRACKET), KC_RIGHT_BRACKET,  KC_TRANSPARENT,
         KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT, (QK_LSFT|KC_BACKSLASH),
           KC_BACKSLASH,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,
         KC_TRANSPARENT, (QK_LSFT|KC_INTERNATIONAL_1),  KC_TRANSPARENT,  KC_TRANSPARENT,
         KC_TRANSPARENT
    ),
    [6] = LAYOUT(
         KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,
         ...
         KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,
         KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,
         KC_TRANSPARENT, (QK_LSFT|KC_LEFT_BRACKET), KC_LEFT_BRACKET,  KC_TRANSPARENT,
         KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,
        (QK_LSFT|KC_QUOTE),  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,
